...
function roots_scripts() {
  ...
  // Uncomment the line below after generating the app.css file, checking the relative paths and commenting the .LESS lines in head.php
  wp_enqueue_style('roots_app', get_template_directory_uri() . '/assets/css/app.css', false, null);

  // Custom Stylesheet for Quick Styling in Prod
  wp_enqueue_style('custom_styles', get_template_directory_uri() . '/assets/css/custom.css', false, null);
...
function bully_scripts() {
  ...
  // Load Image Place Holder for Dev - http://imsky.github.io/holder/
  wp_register_script('holder_js', get_template_directory_uri() . '/assets/js/vendor/holder.js', false, null, true);
  wp_enqueue_script('holder_js');

  // Load Retina.js - http://retinajs.com/
  wp_register_script('retina_js', get_template_directory_uri() . '/assets/js/vendor/retina.js', false, null, true);
  wp_enqueue_script('retina_js');

}
add_action('wp_enqueue_scripts', 'bully_scripts', 100);
