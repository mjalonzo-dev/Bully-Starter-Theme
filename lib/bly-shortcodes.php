...
// Change execution priority of WPAUTOP so that it excecutes after shortcodes are processed instead of before.
// Source: http://sww.co.nz/solution-to-wordpress-adding-br-and-p-tags-around-shortcodes/
remove_filter( 'the_content', 'wpautop' );
add_filter( 'the_content', 'wpautop' , 12);


// Retrieve Content from Pages
function get_content($page_title) {
    ...
    return do_shortcode($page_content->post_content);
}


// Basic 2 Column Short codes for blocks of text
add_shortcode('col1', 'col1_func');
add_shortcode('col2', 'col2_func');

function col1_func($attr, $content = null) {
    return '<div class="col1"><div class="col1-inner">'. do_shortcode( $content ) .'</div></div>';
}

function col2_func($attr, $content = null) {
    return '<div class="col2"><div class="col2_inner">'. do_shortcode( $content ) .'</div></div><div class="clear"></div>';
}

/** Twitter Bootstrap Shortcodes - https://github.com/wearebully/bootstrap-shortcodes **/
